...
// //             <Button className="bg-gradient-to-r from-blue-600 to-blue-800 text-white hover:from-blue-700 hover:to-blue-900 text-base lg:text-lg px-6 py-3">
// //               For Business
// //             </Button>
// //           </Link>
// //           <Sheet>
...
// //             <SheetContent
// //               side="right"
// //               className="w-full max-w-[400px] px-6 py-8 overflow-y-auto bg-gray-800 text-white"
// //             >
...
// //                   </div>
// //                 ))}
// //                 <Link href="/business" className="mt-6 sm:hidden">
      ...
      <div className="container mx-auto flex h-16 sm:h-20 md:h-24 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Sheet>
            ...
            <SheetContent
              side="right"
              className="w-full max-w-[300px] sm:max-w-[400px] px-4 sm:px-6 py-8 sm:py-10 overflow-y-auto bg-gray-800 text-white"
            >
              ...
              >
                ...
                {navItems.map((item) => (
                  <div key={item.title} className="space-y-2 sm:space-y-3">
                    <Link
                      href={item.href}
                      className="text-lg sm:text-xl font-semibold text-white hover:text-blue-400"
                    >
                      {item.title}
                    </Link>
                    {item.content && (
                      <ul className="ml-4 space-y-2 sm:space-y-3">
                        {item.content.map((subItem) => (
                          <li
                            key={subItem.title}
                            className="flex items-center space-x-3"
                          >
                            ...
                            <Link
                              href={subItem.href}
                              className="text-xs sm:text-sm text-gray-200 hover:text-blue-400"
                            >
                              {subItem.title}
                            </Link>
                          </li>
