...
const Contact = () => {
  return (
    <div
      id="contact"
      className="flex flex-col md:flex-row justify-between items-center m-4 md:mx-20 p-4 md:p-6 bg-gray-50 rounded-lg shadow-lg h-auto md:h-[300px] space-y-6 md:space-y-0"
    >
      <div className="flex flex-col justify-center space-y-4 md:space-y-6 md:w-1/2 text-center md:text-left">
        ...
        <div>
          <span className="text-3xl md:text-4xl text-[#1E1F3A] font-light">
